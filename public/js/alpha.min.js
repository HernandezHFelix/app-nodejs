$(document).ready(function(){
	function e(e){
		$(e).block(
            {message:"",css:{border:"none",padding:"0px",margin:"-20px 0 0 0",width:"100%",height:"100%",backgroundColor:"transparent"},overlayCSS:{backgroundColor:"#fff",opacity:.6,cursor:"wait"}}
        )}
    function a(e){
        $(e).unblock()
